...
public class Activity_Add_Expense extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__add_expense);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setHomeAsUpIndicator(R.drawable.icon_close_white);
        getSupportActionBar().setTitle(getResources().getString(R.string.them_chi_tieu));
        getSupportActionBar().setDisplayOptions(ActionBar.DISPLAY_SHOW_CUSTOM);
        getSupportActionBar().setCustomView(R.layout.layout_actionbar);

        add_actionbar_title(getResources().getString(R.string.them_chi_tieu));
        ...
        time.setText(getResources().getString(R.string.hom_nay));
